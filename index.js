...
export {default as NotAuthenticatedError} from './errors/client/auth/not-authenticated.js'
export {default as NotAuthorizedError} from './errors/client/auth/not-authorized.js'
